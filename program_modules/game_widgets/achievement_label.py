    ...
    def __init__(self):
        for index, achievement_name in enumerate(pygame_storage.storage_dict["AchievementManager"].achievements_dict):
            ...
            achievement_description = PygameText(
                text = pygame_storage.storage_dict["AchievementManager"].achievements_dict[achievement_name].description,
                font_size = 25,
                x = initial_x + 25,
            ...
            unlock_image = PygameImage(
                path = pygame_storage.storage_dict["AchievementManager"].achievements_dict[achievement_name].unlock.path,
